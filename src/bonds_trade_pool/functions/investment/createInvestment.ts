...
}) => Promise<{ investment: web3.PublicKey; instructions: web3.TransactionInstruction[]; signers: web3.Signer[] }>;

export const createInvestment: CreateInvestment = async ({
  programId,
  connection,
  args,
  accounts,
