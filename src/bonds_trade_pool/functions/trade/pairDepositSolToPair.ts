...
type PairDepositSolToPair = (params: {
...
export const pairDepositSolToPair: PairDepositSolToPair = async ({ programId, connection, args, accounts, sendTxn }) => {
