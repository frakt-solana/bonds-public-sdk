...
import { EMPTY_PUBKEY, ENCODER, FEE_PREFIX, NFTS_OWNER_PREFIX, SOL_FUNDS_PREFIX, TRADE_PREFIX } from '../../constants';



type StartTrade = (params: {
...
export const startTrade: StartTrade = async ({ programId, connection, args, accounts, sendTxn }) => {
  ...
  return { pair: pair.publicKey, trade: trade, instructions, signers };
};
