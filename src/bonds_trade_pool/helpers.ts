...
import { BondsTradePool, IDL } from './idl/bonds_trade_pool';
...
type ReturnAnchorProgram = (programId: web3.PublicKey, connection: web3.Connection) => Program<BondsTradePool>;
export const returnAnchorProgram: ReturnAnchorProgram = (programId, connection) =>
  new Program<BondsTradePool>(
    IDL as any,
    programId,
