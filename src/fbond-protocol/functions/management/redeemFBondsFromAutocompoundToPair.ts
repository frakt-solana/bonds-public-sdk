...
type RedeemFbondsFromAutocompoundToPair = (params: {
...
export const redeemFbondsFromAutocompoundToPair: RedeemFbondsFromAutocompoundToPair = async ({ programId, connection, accounts, sendTxn }) => {
  ...
  instructions.push(
    await program.methods
      .redeemFbondsFromAutocompoundToPair()
      .accounts({
