...
type RefinanceFBondPnft = (params: {
...
export const refinanceFBondPnft: RefinanceFBondPnft = async ({ programId, connection, accounts, args, sendTxn }) => {
  ...
  return {
    ...
    bondProgramAuthority: newBondProgramAuthority,
    returnFundsOwner: newReturnFundsOwner,
    userTokenAccount,
    collateralTokenAccount: newCollateralTokenAccount,
    userFbondTokenAccount: userNewFbondTokenAccount,
    editionInfo,
    nftMetadata,
    ownerTokenRecord,
    destTokenRecord,
