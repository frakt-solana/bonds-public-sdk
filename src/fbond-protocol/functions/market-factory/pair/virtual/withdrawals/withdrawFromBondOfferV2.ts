...
type WithdrawFromBondOfferV2 = (params: {
...
export const withdrawFromBondOfferV2: WithdrawFromBondOfferV2 = async ({
  programId,
  connection,
  accounts,
  args,
  ...
  instructions.push(
    await program.methods
      .withdrawFromBondOfferV2(new BN(args.amountOfTokensToWithdraw))
      .accounts({
